      ...
      <main className="container-custom max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8" id="main-content" style={{ backgroundColor: 'white' }}>
        ...
        <div className="py-8 sm:py-12 md:py-16 lg:py-32">
          <RevealSection id="colors">
            ...
            />
            <div className="space-y-8 sm:space-y-12 md:space-y-[var(--space-16)] mt-8 sm:mt-12 md:mt-16">
              <div>
                <h3 className="mb-4 sm:mb-6 md:mb-[var(--space-8)]">Base Colors</h3>
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 md:gap-[var(--space-6)]">
              ...
              <div>
                <h3 className="mb-4 sm:mb-6 md:mb-[var(--space-8)]">Semantic Tokens</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 md:gap-[var(--space-6)]">
              ...
              <div>
                <h3 className="mb-4 sm:mb-6 md:mb-[var(--space-8)]">Color Validation</h3>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 md:gap-[var(--space-6)]">
                  <ColorCombination
                    foreground="#1F2937"
                    background="#FAFBFC"
              ...
              <div>
                <h3 className="mb-4 sm:mb-6 md:mb-[var(--space-8)]">Recommended Pairings</h3>
              ...
              <div className="space-y-2 sm:space-y-3 md:space-y-[var(--space-4)]">
                {SPACING_VALUES.map((space) => (
                  <div key={space.name} className="flex items-center gap-3 sm:gap-4 md:gap-[var(--space-6)]">
                    <div className="w-16 sm:w-20 md:w-32 label-m text-[var(--text-secondary)]">{space.name}</div>
                    <div className="w-10 sm:w-12 md:w-16 body-s text-[var(--text-tertiary)] font-mono">{space.value}</div>
                    <div
